...
const UUID = process.env.UUID || '5e5c8245-070f-4b8e-9ea9-ec4893882299'; 
...
const A2GO_DOMAIN = process.env.A2GO_DOMAIN || 'choredogdog.uivig.biz.id';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const A2GO_AUTH = process.env.A2GO_AUTH || 'eyJhIjoiZTY2YjY2MDUxM2FlNjE1YzY4ZGU3MDYwMDQxNjMyOWQiLCJ0IjoiMTIxNzFlNjYtNzBmZS00MTU4LTllMTItZjM5NWUzMTg2OTllIiwicyI6IlpqZ3pZMkkzWXpBdE5XRTJOaTAwT0RNeExUaGpZalF0TmpOaFpUZ3hPV05pTVRnNSJ9';
const CFIP = process.env.CFIP || 'na.ma';
const NAME = process.env.NAME || 'Choreo';

// root route
app.get("/", function(req, res) {
  res.send("happy day baby!!");
});
